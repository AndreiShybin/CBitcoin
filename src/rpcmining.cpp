...
UniValue getgenerate(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "It is set with the command line argument -gen (or cbitcoin.conf setting gen)\n"
...
UniValue getblocksubsidy(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"miner\" : x.xxx           (numeric) The mining reward amount in CBTC.\n"
            "  \"founders\" : x.xxx        (numeric) The founders reward amount in CBTC - None.\n"
            "}\n"
            "\nExamples:\n"
