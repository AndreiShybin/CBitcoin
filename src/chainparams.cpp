...
public:
    CMainParams() {
        ...
        consensus.nPowDifficultyBombHeight = 3900000;
        ...
        consensus.nUnmovedBurnHeight = 4280000;
        consensus.zResetHeight = 855500;
        ...
        vSeeds.push_back(CDNSSeedData("dnsseed.bitclassic.info", "dnsseed.dnsseed.bitclassic.info"));

        // guarantees the first 2 characters, when base58 encoded, are "C1"
        base58Prefixes[PUBKEY_ADDRESS]     = {0x1c,0x25};
        // guarantees the first 2 characters, when base58 encoded, are "Cx"
        ...
        checkpointData = {
            {
                ...
                { 472029, uint256S("0x2475ffd9a9fa0a11987e764dac110297f43f7c23f946499abe00be6f3b1f4039") },
                { 472031, uint256S("0xc86b052737bc18c9d75460386d43139568632eb53605e7fc97385e09d84d1686") },
                { 472032, uint256S("0xcf59ddfac1f0bc54c4def136967f2f8ee4607e5809669e6faab80de89d0c0041") },
                { 475029, uint256S("0x601590e1c71ef6cab6cb3f4cc94f26619f73f2530ee78d8cf23f702e7a14ad41") },
        ...
        nForkStartHeight = 472028;
        nForkHeightRange = 5134;
    }
};
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("classicbitcoin.info", "dnsseed.testnet.classicbitcoin.info"));
        vSeeds.push_back(CDNSSeedData("dnsseed.bitclassic.info", "dnsseed.testnet1.dnsseed.bitclassic.info"));
