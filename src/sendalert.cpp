...
// Copyright (c) 2018 The Classic Bitcoin developers
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "Your client is out of date and vulnerable to denial of service. Please update to the most recent version of Classic Bitcoin. More info at: https://classicbitcoin.info/";
    alert.strRPCError   = alert.strStatusBar;

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/CBTC:1.0.12/"));
    const std::vector<std::string> useragents = {"CBTC"};
