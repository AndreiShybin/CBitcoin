...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\CBitcoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\CBitcoin
    // Mac: ~/Library/Application Support/CBitcoin
    // Unix: ~/.cbitcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "CBitcoin";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "cbitcoin.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    {
        // Don't overwrite existing settings so command line settings override cbitcoin.conf
...
{
    return "\n" +
           FormatParagraph(strprintf(_("To ensure you are fully protecting your privacy when running CBTC, see <%s>."),
...
std::string LicenseInfo()
{
    return "\n" +
           ...
           FormatParagraph(strprintf(_("Copyright (C) 2017-%i The Classic Bitcoin Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
