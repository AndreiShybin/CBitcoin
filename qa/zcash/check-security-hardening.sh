...
test_rpath_runpath "${REPOROOT}/src/cbtcd"
test_rpath_runpath "${REPOROOT}/src/cbtc-cli"
...
test_fortify_source "${REPOROOT}/src/cbtcd"
test_fortify_source "${REPOROOT}/src/cbtc-cli"
