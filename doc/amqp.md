...
The Classic Bitcoin daemon can be configured to act as a trusted "border
router", implementing the Classic Bitcoin P2P protocol and relay, making
...
The AMQP feature in Classic Bitcoin requires [Qpid Proton](https://qpid.apache.org/proton/)
...
These options can also be provided in cbitcoin.conf.
...
TLS support may be added once OpenSSL has been removed from the Classic Bitcoin
