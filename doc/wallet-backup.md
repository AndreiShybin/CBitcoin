...
Backing up your Bitcoind Private private keys is the best way to be proactive about preventing loss of access to your cbtc.
...
For all methods, you will need to include an export directory setting in your config file (`cbitcoin.conf` located in the data directory which is `~/.cbtc/` unless it's been overridden with `datadir=` setting):
