#!/bin/bash
## Usage:
##  ./cbtcutil/build-debian-package.sh
...
cp $SRC_PATH/cbtcutil/fetch-params.sh $DEB_BIN/zcash-fetch-params
# Copy docs
...
cp $SRC_PATH/contrib/bitcoind.bash-completion $DEB_CMP/cbtcd
cp $SRC_PATH/contrib/bitcoin-cli.bash-completion $DEB_CMP/cbtc-cli
# Gzip files
