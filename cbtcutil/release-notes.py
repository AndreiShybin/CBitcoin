...
## Sums commits made by contributors in each Classic Bitcoin release note in ./doc/release-notes and writes to authors.md
def document_authors():
    ...
    with open(authors_file, 'w') as f:
        f.write('Classic Bitcoin Contributors\n==================\n\n')
        total_contrib = {}
