...
SPROUT_PKEY_URL="https://s3.amazonaws.com/zcashfinalmpc/$SPROUT_PKEY_NAME"
SPROUT_VKEY_URL="https://s3.amazonaws.com/zcashfinalmpc/$SPROUT_VKEY_NAME"
...
This script will fetch the Classic Bitcoin (and Zcash) zkSNARK parameters, and verify
